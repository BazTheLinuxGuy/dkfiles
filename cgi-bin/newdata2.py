...
# Updated Sunday, June	8, 2025 03:58:35
'''
#cd ../cgi
...
def return_html(nextid: int) -> None:
	...
	for key in list(locations):
		myhtml += f'<option value={key}>{locations[key]}</option>'
	myhtml += '</select>'
	w(f'\n\n{myhtml = }')
	w('\n\n')

# <option value="rf">{locations['rf']}</option>
# <option value="rb">{locations['rb']}</option>
# <option value="dd">{locations['dd']}</option>
# <option value="db">{locations['db']}</option>
# <option value="ut">{locations['ut']}</option>
# <option value="at">{locations['at']}</option>
# <option value="cl">{locations['cl']}</option>
# <option value="ds">{locations['ds']}</option>
# <option value="bz">{locations['bz']}</option>
# <option value="un">{locations['un']}</option>
# <option value="lo">{locations['lo']}</option>
# </select>
	myhtml += f'''<p>Owner:</p>
...
<input type="text" id="comments" name="comments" size="80" />
<br /><br />
...
<body>
	  ...
	  <form name="myform" id="myform" method="post" action="/cgi-bin/process_new.py">
		  ...
		  <input type="number" size="6" id="fileid" name="fileid" />
		  <br />
